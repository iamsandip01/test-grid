    ...
    <>
      ...
      <section className="contact-section">
        <div id="img1" className="contact-image">
          <img
            src="https://iamsandip01.github.io/test-grid/assets/con_img.jpg"
            alt="Office Interior"
          />
        </div>
        <div id="details1" className="contact-details">
          ...
          <h3>EMAIL</h3>
          <p>
            <a className="email" href="mailto:info@9griddesign.com">
      ...
      <section className="join-team">
        ...
        <p>
          ...
          <a href="mailto:info.9griddesign@gmail.com">
            info.9griddesign@gmail.com
          </a>
        </p>
      </section>
      ...
      <div className="whatsapp-button">
        <a 
          href="https://wa.me/+919007779889" 
          target="_blank" 
          rel="noopener noreferrer"
        >
          <img
            src="https://iamsandip01.github.io/test-grid/assets/whatsapp_logo.jpg"
            alt="WhatsApp"
